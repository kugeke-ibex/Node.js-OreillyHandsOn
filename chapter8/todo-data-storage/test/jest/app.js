...
// テスト完了後にHTTPサーバーを終了
// Chai HTTPだとリクエスト送信する処理の中でHTTPサーバーの開始と終了を行ってくれる。
afterAll(() => app.close());
...
describe("app", () => {
    describe("GET /api/todos", () => {
        ...
        describe("POST /api/todos", () => {
            test("パラメーターで指定したタイトルを引数にcreate()を実行し、結果を返す", async () => {
                // uuid.v4()が返す値を指定
            ...
            test("パラメーターにタイトルが指定されていない場合、400エラーを返す", async () => {
